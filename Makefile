...
$(MT32EMUBUILDDIR)/.done: $(CIRCLESTDLIBHOME)/.done
	...
	cmake -B $(MT32EMUBUILDDIR) \
		 ...
		 $(MT32EMUHOME) \
		 >/dev/null
	@/usr/bin/cmake --build $(MT32EMUBUILDDIR)
	@touch $@
